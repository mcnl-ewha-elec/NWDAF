...
## 프로그램 명칭(영문)
Energy consumption prediction simulator using weighted model using prediction error of multiple adaboost models
...
2. parallel_adaboost.py 파일을 실행시키고 원하는 예측하고자 하는 날짜를 선택한다.
